...
ROOT_URLCONF = 'VirtualClassroom.src.urls'
...
WSGI_APPLICATION = 'VirtualClassroom.src.wsgi.application'
...
STATIC_URL = '/VirtualClassroom/static/'
...
MEDIA_URL = '/VirtualClassroom/media/'
