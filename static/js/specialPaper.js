//Uncomment this code once I finish integrating lizara's code
// let quiz;
// fetch('/get_questions_for_specialPaper')
//   .then(response => response.json())
//   .then(data => {
//     quiz = data;
//   });

//Comment this code once I finish integrating lizara's code
const quiz=[
{
